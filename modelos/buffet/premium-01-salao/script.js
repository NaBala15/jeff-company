/* ==================================================================
   PREMIUM 01 — SALÃO  |  Espaço Vinhedo
...
(function () {
  ...
  if (temObservador && !menosMovimento) {
    var alvos = document.querySelectorAll(
      '.secao, .hero__conteudo, .numero, .faixa-cta__interno, .celebracao, .galeria > li'
    );
    ...
    alvos.forEach(function (el, i) {
      ...
      if (el.classList.contains('celebracao') || el.parentElement.classList.contains('galeria')) {
