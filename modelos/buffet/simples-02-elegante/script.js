/* ==================================================================
   SIMPLES 02 — ELEGANTE / EUCALIPTO  |  Casa Aurora Eventos
...
(function () {
  ...
  var topo = document.querySelector('.cabecalho');
  ...
  /* ---------- 3) APARIÇÃO AO ROLAR ---------- */
  var alvos = document.querySelectorAll('.secao, .hero__texto, .foto--hero');
