/* ==========================================================================
   ...
   ESPAÇO VIVO — institucional · Simples 2
...
(function () {
  ...
  var alvos = document.querySelectorAll('.cartao, .pessoa, .lista li');
  ...
  /* ==================================================================
     ...
     Existe porque esta página tem nome, profissionais e número de CRP
     inventados. Sem o aviso, quem chega pelo formulário lê aquilo como se
     fosse consultório de verdade.
  ...
  if (location.search.indexOf('demo=1') !== -1) {
    ...
    aviso.innerHTML =
      ...
      '<span>O nome do consultório, as psicólogas, os números de CRP e as ' +
