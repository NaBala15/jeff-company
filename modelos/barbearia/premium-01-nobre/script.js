/* ==================================================================
   PREMIUM 01 — CLUBE  |  Nobre Barber Club
...
(function () {
  ...
  if (temObservador && !menosMovimento) {
    var alvos = document.querySelectorAll(
      '.secao, .hero__conteudo, .faixa__item, .faixa-cta__interno, .servico, .mosaico > li'
    );
    ...
    alvos.forEach(function (el, i) {
      ...
      if (el.classList.contains('servico') || el.parentElement.classList.contains('mosaico')) {
