/* ==================================================================
   PREMIUM 01 — CENOGRAFIA  |  Cenário Vivo
...
(function () {
  ...
  if (temObservador && !menosMovimento) {
    var alvos = document.querySelectorAll(
      '.secao, .hero__conteudo, .numero, .faixa-cta__interno, .servico, .galeria > li'
    );
    ...
    alvos.forEach(function (el, i) {
      ...
      if (el.classList.contains('servico') || el.parentElement.classList.contains('galeria')) {
