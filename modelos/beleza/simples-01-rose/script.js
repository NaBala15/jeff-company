/* ==================================================================
   SIMPLES 01 — SUAVE / ROSÉ  |  Espaço Camélia
...
(function () {
  ...
  document.addEventListener('click', function (e) {
    ...
    var topo = alvo.getBoundingClientRect().top + window.pageYOffset - altura - 10;
  ...
  /* ---------- 3) APARIÇÃO AO ROLAR ---------- */
  var alvos = document.querySelectorAll('.secao, .hero__texto, .foto--arco');
